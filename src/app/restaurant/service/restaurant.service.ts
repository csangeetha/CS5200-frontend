...
export class RestaurantService {
  ...
  getRestaurant(resId: any){
    ...
    makeFavorite(res: any, userId:number){
      return this.http.post('http://localhost:8080/CS5200-project-new/rest/restaurant/createFavRestaurant/'+userId,res,this.new_headers);
    }
    ...
    createRestaurant(restaurant: any){
      ...
      return this.http.post('http://localhost:8080/CS5200-project-new/rest/restaurant/restaurantcreation/17', restaurant, this.new_headers)
    }

    createOrder(userId, resId,foodRecipeId,order){
      return this.http.post('http://localhost:8080/CS5200-project-new/rest/restaurant/createorder?userId='
